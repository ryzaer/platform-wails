...
ClickNext=Klik Lanjut untuk meneruskan, atau Batal untuk keluar.
BeveledLabel=
...
PasswordLabel3=Silakan masukkan kata sandi, lalu klik Lanjut untuk meneruskan. Kata sandi bersifat sensitif-kapitalisasi.
...
InfoBeforeClickLabel=Saat Anda siap meneruskan instalasi, klik Lanjut.
WizardInfoAfter=Informasi
InfoAfterLabel=Silakan baca informasi penting berikut sebelum meneruskan.
InfoAfterClickLabel=Saat Anda siap meneruskan instalasi, klik Lanjut.
...
SelectDirBrowseLabel=Untuk meneruskan, klik Lanjut. Bila Anda ingin memilih map lain, klik Cari.
;Inno6
...
DiskSpaceWarning=Kami memerlukan sedikitnya %1 KB ruang bebas untuk memasang, namun diska yang Anda pilih hanya memiliki %2 KB tersedia.%n%nLanjut terus?
...
SelectComponentsLabel2=Centang komponen yang Anda inginkan; hapus centang dari komponen yang tidak Anda inginkan. Klik Lanjut saat Anda siap meneruskan.
...
NoUninstallWarning=Kami mendeteksi bahwa komponen berikut telah terpasang pada komputer Anda:%n%n%1%n%nMembatalkan pilihan atas komponen berikut bukan berarti melepasnya.%n%nLanjut terus?
ComponentSize1=%1 KB
ComponentSize2=%1 MB
;Inno6
...
SelectTasksLabel2=Pilih tugas tambahan yang Anda ingin kami jalankan ketika memasang [name], lalu klik Lanjut.
...
SelectStartMenuFolderBrowseLabel=Untuk meneruskan, klik Lanjut. Bila Anda ingin memilih map lain, klik Cari.
...
AddonHostProgramNotFound=%1 tidak dapat ditemukan di map yang Anda pilih.%n%nLanjut terus?